...
export function EquipmentMapping() {
  ...
  return (
    <div>
      <h2 className="text-xl font-semibold mb-4">Equipment-Zone-Week Mapping</h2>
      ...
      <div className="bg-gray-50 p-4 rounded-lg mb-6">
        <h3 className="font-medium mb-4">Create New Mapping</h3>
      ...
      {/* Existing Mappings */}
      <div>
        <h3 className="font-medium mb-4">Existing Mappings ({mappings.length})</h3>
